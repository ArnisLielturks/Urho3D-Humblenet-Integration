...
#define INTERFACE( X )  \
	...
	X( void,                            libwebrtc_set_turn_server,              ( struct libwebrtc_context* ctx, const char* address, const char* username, const char* password),      (ctx, address, username, password) ) \
