...
//    if (wsi) {
//        if (lws_hdr_total_length(wsi, WSI_TOKEN_HTTP_X_FORWARDED_FOR)) {
//            char header[50];
//            lws_hdr_copy(wsi, header, 50, WSI_TOKEN_HTTP_X_FORWARDED_FOR);
//            printf("HEADER WSI_TOKEN_HTTP_X_FORWARDED_FOR 2222 %s", header);
//        }
//    }
//    if (wsi) {
//        if (lws_hdr_total_length(wsi, WSI_TOKEN_HTTP_X_REAL_IP)) {
//            char header[50];
//            lws_hdr_copy(wsi, header, 50, WSI_TOKEN_HTTP_X_REAL_IP);
//            printf("HEADER WSI_TOKEN_HTTP_X_REAL_IP 2222 %s", header);
//        }
//    }
	switch (reason) {
    ...
    case LWS_CALLBACK_FILTER_PROTOCOL_CONNECTION:
        {
//            LOG_ERROR("EEE 111 LWS_CALLBACK_FILTER_PROTOCOL_CONNECTION\n");
//            if (wsi) {
//                LOG_ERROR("EEE 222 LWS_CALLBACK_FILTER_PROTOCOL_CONNECTION\n");
//                if (lws_hdr_total_length(wsi, WSI_TOKEN_HTTP_X_FORWARDED_FOR)) {
//                    char header[50];
//                    lws_hdr_copy(wsi, header, 50, WSI_TOKEN_HTTP_X_FORWARDED_FOR);
//                    LOG_ERROR("HEADER 1111 %s", header);
//                }
//            }
//            if (wsi) {
//                if (lws_hdr_total_length(wsi, WSI_TOKEN_HTTP_X_REAL_IP)) {
//                    char header[50];
//                    lws_hdr_copy(wsi, header, 50, WSI_TOKEN_HTTP_X_REAL_IP);
//                    LOG_ERROR("HEADER WSI_TOKEN_HTTP_X_REAL_IP 1111 %s", header);
//                }
//            }
            break;
        }
...
int main(int argc, char *argv[]) {
	...
	std::clog << "Config file " << configFile << " used" << std::endl;
	if (!proxy.empty()) {
        std::clog << "Proxy address " << proxy << " used" << std::endl;
    }
    ...
    peerServer->turnServerAddress = config.turnServerAddress;
